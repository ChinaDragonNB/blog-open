    ...
    <el-form ref="form" :model="form" class="boxShadow">
      <el-row>
        ...
        <el-col :xl="10" :lg="10" :md="10" :sm="10" :xs="24">
          <el-form-item label="所属分类：" label-width="1">
      ...
      <el-form-item label="文章封面">
        <br>
        <el-input v-model="form.cover" placeholder="请输入封面链接" clearable size="small" style="width:50%;"
                  autofocus/>
        <el-upload class="avatar-uploader" :action="form.uploadImgAction" :show-file-list="true"
        ...
        <el-col :md="24" :xl="24" :lg="24" :xs="24">
          ...
          <div class="mavonEditor">
            <mavon-editor ref=md v-model="form.markdown" :style="zIndex" :toolbars="markdownOption"
                          ...
                          :value="form.markdown" :fontSize="editorOption.fontSize"
                          ...
                          :subfield="editorOption.subfield"
                          :defaultOpen="editorOption.defaultOpen" :previewBackground="editorOption.previewBackground"
                          :autofocus="false"
...
import { articleInfoApi, listTagApi, saveApi, selectedTagsApi, uploadCoverApi, uploadImgApi } from '../../api/article'
...
export default {
  ...
  methods: {
    ...
    commitData() {
      ...
      saveApi('edit', articleData).then(res => {
    ...
    articleInfo(id) {
      articleInfoApi(id).then(res => {
        if (res.data.resultCode == 1) {
          ...
          this.form.articleDescribe = res.data.resultData.articleDescribe
